use super::{AutomationLane, AutomationPoint, Clip, Note, Take, Track};
...
pub enum UndoData {
    ...
    MovedNotes {
        original_positions: HashMap<String, (f64, u8)>,
    }, // note_id -> (start_time, pitch)
    ResizedNote {
        original_start: f64,
    ...
    RemovedAutomationLane {
        lane: AutomationLane,
    },
    AutomationVisibility {
        was_visible: bool,
    },
    AddedAutomationPoint {
        point_id: String,
    },
    DeletedAutomationPoints {
        points: Vec<(String, AutomationPoint)>,
    }, // (lane_id, point)
    UpdatedAutomationPoint {
        original_time: f64,
        original_value: f64,
    },
    ...
    PunchPoints {
        previous_in: Option<f64>,
        previous_out: Option<f64>,
    },
    CountInBars {
        previous_bars: u32,
    },
    ...
    SelectedTake {
        previous_take_id: Option<String>,
    },

    // Quantization
    QuantizedNotes {
        original_timings: HashMap<String, (f64, u32)>,
    }, // note_id -> (start_time, start_tick)
